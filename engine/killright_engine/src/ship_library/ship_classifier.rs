...
use crate::ship_library::configuration_loader::load_default_configuration;
use crate::ship_library::ship_classification_models::{
    ShipClassificationConfiguration, ShipClassificationDefinition,
};
...
impl ShipClassifier {
    ...
    pub fn classify(&self, ship_type_id: Option<i64>) -> Option<&ShipClassificationDefinition> {
...
mod tests {
    ...
    use crate::ship_library::ship_classification_models::ShipDefinition;

    fn test_configuration() -> ShipClassificationConfiguration {
